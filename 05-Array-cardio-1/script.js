...
//   const lastName = inventors.map(inventor => `${inventor.first} ${inventor.last}`)
...
// const reduced = inventors.reduce(function(total, inventor) {
...
// const sortingLastName = people.sort(function(a, b) {
//     if(a > b){
//         return 1
//     } else {
//         return -1
